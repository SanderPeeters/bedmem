        ...
        channel.bind('choose_level', function(data) {
            ...
            (function(){
                var myMem = new Memory({
                    ...
                    //shuffledCards: '[{"id":11,"img":"img/default/monsters-11.png"},{"id":12,"img":"img/default/monsters-12.png"},{"id":11,"img":"img/default/monsters-11.png"},{"id":10,"img":"img/default/monsters-10.png"},{"id":15,"img":"img/default/monsters-15.png"},{"id":10,"img":"img/default/monsters-10.png"},{"id":15,"img":"img/default/monsters-15.png"},{"id":12,"img":"img/default/monsters-12.png"}]',
