...
;(function( window ) {
    ...
    Memory.prototype._setupGame = function() {
       ...
       */
        ...
        this.chosenLevel = "";
        this.numMoves = 0;
        this.personalWinningPairCounter = 0;
      ...
      <span class="mg__meta--pairs">Score: \
      <span id="mg__meta--pairs">' + this.personalWinningPairCounter + '</span>\
      </span>\
      </div>\
    ...
    Memory.prototype._renderTiles = function() {
       ...
       */
        ...
        <div class="mg__tile--inner" id="mg__tile_to_click-' + n + '" data-id="' + this.newCards[i]["id"] + '" onclick="cardClicked(' + n + ')" >\
    ...
    Memory.prototype._gameCardsMatch = function() {
        ...
        this._gamePersonalWinningPairCounterPlusOne();
  ...
  /*Memory _gamePersonalWinningPairCounterPlusOne
   * When a user has guessed a correct pair his score counter goes up
   * */

    Memory.prototype._gamePersonalWinningPairCounterPlusOne = function() {
        if(isYourTurn){
            this.personalWinningPairCounter = this.personalWinningPairCounter + 1;
            this.scoreCounterUpdate = document.getElementById("mg__meta--pairs").innerHTML = this.personalWinningPairCounter;
        }
    };
    ...
    Memory.prototype._winGame = function() {
        ...
        <p class="mg__onend--message">' + mem_end_text_3 + this.personalWinningPairCounter + mem_end_text_4+'</p>\
